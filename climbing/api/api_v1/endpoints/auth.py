...
router.include_router(fastapi_users.get_register_router(UserRead, UserCreate))  # type: ignore
router.include_router(fastapi_users.get_verify_router(UserRead))  # type: ignore
